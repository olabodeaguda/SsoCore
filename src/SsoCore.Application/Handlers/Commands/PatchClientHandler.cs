...
{
    public class PatchClientRequest : IRequest<Result<ClientDto>>
    {
    ...
    public class PatchClientHandler : IRequestHandler<PatchClientRequest, Result<ClientDto>>
    {
        private readonly IClientService _clientService;
        private readonly IMapper _mapper;
        private readonly ILogger<PatchClientHandler> _logger;
        public PatchClientHandler(IClientService clientService, IMapper mapper, ILogger<PatchClientHandler> logger)
        {
        ...
        public async Task<Result<ClientDto>> Handle(PatchClientRequest request, CancellationToken cancellationToken)
        {
